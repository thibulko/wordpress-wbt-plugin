...
class Fwt2
{
    ...
    {
        require_once FWT_DIR . 'includes2/class-fwt-loader.php';
        $this->loader = new Fwt_Loader();

        require_once FWT_DIR . 'includes2/class-fwt-config.php';
        $this->config = new Fwt_Config();

        require_once FWT_DIR . 'includes2/class-fwt-translate.php';
        $this->translate = new Fwt_Translate( $this->config );

        require_once FWT_DIR . 'includes2/class-fwt-api.php';
